<%@ Page Language="C#" AutoEventWireup="true" CodeFile="DisplayUser_Attributes.aspx.cs" Inherits="DisplayUser_Attributes" %>

<!DOCTYPE html>

<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>Display User and all attributes</title>
...
<div class="container">
        ...
        <form runat="server">
            ...
            <h2 class="mt-3">Enter User ID to display specific user with all attributes</h2>
